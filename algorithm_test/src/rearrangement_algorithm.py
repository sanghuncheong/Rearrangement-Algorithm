...
from envClass4altest import EnvInfo as EI
from envClass4altest import CanInfo as CI
...
if __name__ == '__main__':
    ...
    ws_w, ws_d = 45, 90  # get table size in the v-rep
    ws_cen = [1.2, 0.00]
    rob_pos = [0.0, 0.0]
    OBJ_R = 0.035
            ...
            for method in compare_method:
                ...
                while len(env.ore_order):   # this while loop is for the algorithm algorithm will go on until it can access to target
                    ...
                    if len(env.ore_order) == 0:
                        print "end rearrangement successfully"
